...
*/
    ...
    IFRAME_DEFAULT      : "../TextEditor/",  // "/iframe/default/",
...
WYMeditor.editor.prototype.init = function() {
  ...
  if(WymClass) {
   ...
   var aContainers = eval(style_list); // eval(this._options.containersItems);
      var sContainers = "";
      for(var i = 0; i < aContainers.length; i++) {
        ...
        if(oContainer.name && oContainer.title)
          ...
          sContainer = h.replaceAll(sContainer, WYMeditor.CONTAINER_TITLE, oContainer.title);
